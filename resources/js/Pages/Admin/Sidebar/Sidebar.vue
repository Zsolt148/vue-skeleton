...
import SidebarHeader from '@/Pages/Admin/Sidebar/SidebarHeader.vue'
import SidebarContent from '@/Pages/Admin/Sidebar/SidebarContent.vue'
import SidebarFooter from '@/Pages/Admin/Sidebar/SidebarFooter.vue'
